                            ...
                            <div class="bg-white rounded-lg border border-gray-200 shadow-sm">
                                <div class="p-4 border-b border-gray-200">
                                    <div class="flex items-center justify-between mb-4">
                                        ...
                                        <button
                                            @click="isEditingQuestion = true; editingQuestionId = null; questionForm = { text: '', type: 'text', required: false, answers: [], placeholder: '', help_text: '' }"
                                    ...
                                    <template x-if="isEditingQuestion">
                                        <div class="p-4 bg-blue-50 border border-blue-200 rounded-lg space-y-4">
                                            ...
                                            <div>
                                                <label class="block text-sm font-medium mb-2">Placeholder Text (optional)</label>
                                                <input type="text" class="w-full px-3 py-2 border border-gray-300 rounded text-sm" placeholder="e.g., Enter your answer here..." x-model="questionForm.placeholder">
                                            </div>
                                            <div>
                                ...
                                <div class="divide-y divide-gray-200 max-h-[600px] overflow-y-auto">
                                    ...
                                    <template x-for="(question, index) in selectedCategory.questions" :key="question.id">
                                    ...
                                    <template x-for="question in category.questions" :key="question.id">
                                        <div>
                                            <label class="block text-sm font-medium mb-2">
                                                ...
                                                <template x-if="question.required"><span class="text-red-600 ml-1">*</span></template>
                                            </label>
                                            <template x-if="question.help_text">
                                                <p class="text-xs text-gray-600 mb-2" x-text="question.help_text"></p>
                                            </template>
    ...
    return {
        ...
        async saveQuestion() {
            ...
            const payload = {
                ...
                order: this.selectedCategory.questions.length + 1,
            ...
            this.questionForm = { text: '', type: 'text', required: false, answers: [], placeholder: '', help_text: '' };
        },
